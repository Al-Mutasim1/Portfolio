...
export default function Navbar() {
  ...
  return <>
    { (pathName === '/' )?  <div className='d-flex main-page border-color  vh-100 overflow-hidden'> 
      ...
      <nav className="navbar navbar-expand-lg flex-column main-page min-vh-100  d-flex navbar-white navColor">
        <div className="container-fluid ">
          ...
          <div className="collapse navbar-collapse fw-bold" id="navbarSupportedContent">
            ...
            <div className="social orange-text w-100  fs-2 mt-5 d-flex mx-auto justify-content-center align-items-center  row">
